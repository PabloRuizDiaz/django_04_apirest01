...
PUBLIC_KEY = 'f7874464b1b87342fe6530d2e8bd9010'
PRIVATE_KEY = 'a279c5579bbe9366b0fae88014775c07cf6178e5'
TS = 1
...
def get_comics(request):
    ...
    params = PARAMS
    params.update(aditional_params) # NOTE: A los parametros de hash, api key y demás, sumamos limit y offset para paginación.
    ...
    for i in range(len(id)):
        ...
        if prices[i] == 0.00:  # Con este condicional inhabilitamos la compra de los comics sin precio.
            price = "<h3>N/A<h3>"
            visibility = "hidden"
        else:
            price = prices[i]
